...
//
// For each of the 30 stable .bp-card ids on the page, this generator:
...
// ---------------------------------------------------------------------------
const CARD_MAP = {
  'mod-power-plant':            [[null, 'standard/power_plant']],
  'mod-thrusters':             [[null, 'standard/thrusters']],
  'mod-frame-shift-drive':     [[null, 'standard/frame_shift_drive']],
  'mod-life-support':          [[null, 'standard/life_support']],
  'mod-power-distributor':     [[null, 'standard/power_distributor']],
  'mod-sensors':               [[null, 'standard/sensors']],
  'mod-fuel-tank':             [[null, 'standard/fuel_tank']],
  'mod-shield-generator':      [['Standard', 'internal/shield_generator'],
                                ['Bi-Weave', 'internal/bi_weave_shield_generator'],
                                ['Prismatic', 'internal/pristmatic_shield_generator']],
  'mod-shield-cell-bank':      [[null, 'internal/shield_cell_bank']],
  'mod-hull-reinforcement':    [[null, 'internal/hull_reinforcement_package']],
  'mod-module-reinforcement':  [[null, 'internal/module_reinforcement_package']],
  'mod-guardian-fsd-booster':  [[null, 'internal/guardian_fsd_booster']],
  'mod-fuel-scoop':            [[null, 'internal/fuel_scoop']],
  'mod-detailed-surface-scanner': [[null, 'internal/surface_scanner']],
  'mod-cargo-rack':            [[null, 'internal/cargo_rack']],
  'mod-passenger-cabin':       [['Economy', 'internal/economy_passenger_cabin'],
                                ['Business', 'internal/business_passenger_cabin'],
                                ['First', 'internal/first_passenger_cabin'],
                                ['Luxury', 'internal/luxury_passenger_cabin']],
  'mod-afmu':                  [[null, 'internal/auto_field_maintenance_unit']],
  'mod-limpet-controllers':    [['Collector', 'internal/collector_limpet_controllers'],
  ...
  'mod-refinery':              [[null, 'internal/refinery']],
  'mod-fsd-interdictor':       [[null, 'internal/frame_shift_drive_interdictor']],
  'mod-flight-assists':        [['Docking Computer', 'internal/docking_computer'],
                                ['Supercruise Assist', 'internal/supercruise_assist'],
                                ['Fighter Hangar', 'internal/fighter_hangar']],
  'util-shield-booster':       [[null, 'hardpoints/shield_booster']],
  'util-countermeasures':      [['Heat Sink Launcher', 'hardpoints/heat_sink_launcher'],
                                ['Chaff Launcher', 'hardpoints/chaff_launcher'],
                                ['Point Defence', 'hardpoints/point_defence'],
                                ['ECM', 'hardpoints/electronic_countermeasure']],
  'util-scanners':             [['Kill Warrant Scanner', 'hardpoints/kill_warrant_scanner'],
                                ['Manifest Scanner', 'hardpoints/cargo_scanner'],
                                ['Frame Shift Wake Scanner', 'hardpoints/frame_shift_wake_scanner']],
  'util-xeno':                 [['Xeno Scanner', 'hardpoints/xeno_scanner'],
  ...
  'wpn-lasers':                [['Beam Laser', 'hardpoints/beam_laser'],
                                ['Burst Laser', 'hardpoints/burst_laser'],
                                ['Pulse Laser', 'hardpoints/pulse_laser']],
  'wpn-kinetic':               [['Multi-Cannon', 'hardpoints/multi_cannon'],
                                ['Cannon', 'hardpoints/cannon'],
                                ['Fragment Cannon', 'hardpoints/fragment_cannon'],
                                ['Rail Gun', 'hardpoints/rail_gun']],
  'wpn-explosive':             [['Missile Rack', 'hardpoints/missile_rack'],
                                ['Torpedo Pylon', 'hardpoints/torpedo_pylon'],
                                ['Mine Launcher', 'hardpoints/mine_launcher']],
  'wpn-plasma':                [[null, 'hardpoints/plasma_accelerator']],
  'wpn-guardian-ax':           [['Guardian Gauss Cannon', 'hardpoints/guardian_gauss_cannon'],
...
const LABELS = {
  ...
  passengers: 'Passengers', bins: 'Refinery Bins', bays: 'Fighter Bays',
