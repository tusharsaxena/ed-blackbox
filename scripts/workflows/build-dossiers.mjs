...
STEP C — sources (data/sources/ships/ship-dossiers/${c.slug}.json): schema { page, lead:["Figures on this page are verified against the sources below."], sources:[{label,what,url,display}] }. EXTERNAL references only (Coriolis, EDSY, elitedangerous.com, EDCD coriolis-data, Inara, Fandom) — never a link to another page on this site. Model it on data/sources/ships/ship-dossiers/${c.template}.json.
...
- LEAVE AS SHELLS (regenerated later — just .sec-head + a one-line intro <p>, copy the template's shell): §03 section-why-this-rating, §06 section-3-state-loadout, §09 section-engineering-plan, §13 section-credits. Keep the .vchips "Other role builds" placeholder wrapper.
