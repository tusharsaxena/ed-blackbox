...
<div class="wrap">
  ...
  <section id="section-about-site">
    ...
    <p>The <strong>Elite:Dangerous Black Box</strong> is where I keep the notes I got tired of re-looking-up &mdash; which ship to fly for a job, how to unlock an engineer, what a blueprint costs, where to farm the mats. It's all in one cross-linked place now, written the way one commander would explain it to another.</p>
...
cat <<'FOOT'
  ...
  <section id="section-faq">
    ...
    <div class="cards one">
      ...
      <div class="card"><h4>Found an error, or want to contribute?</h4><p>This is a personal project by CMDR Ka0s. Spot a wrong number, a broken link, or a build you'd fit differently? <a href="https://github.com/tusharsaxena/ed-blackbook/issues">Open an issue on GitHub</a>. Ratings and loadouts are opinions &mdash; disagree and say why; a well-argued correction gets folded in.</p></div>
    </div>
  </section>
