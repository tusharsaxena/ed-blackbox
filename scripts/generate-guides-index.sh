    ...
    <div class="header-qn">
      ...
      <div class="qn-dd" id="qn-dd">
        ...
        <div class="qn-panel" id="qn-panel" role="listbox">
          ...
          <a class="qn-item" href="#activities"><span class="qn-dot amber"></span><span class="qn-nm">Activity Guides</span><span class="qn-side">Ships</span></a>
...
<div class="wrap">
  ...
  <section id="dossiers">
    ...
    <h3 class="subhead" id="activities">Activity Guides</h3>
