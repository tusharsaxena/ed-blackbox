    ...
    <div class="header-qn">
      ...
      <div class="qn-dd" id="qn-dd">
        ...
        <div class="qn-panel" id="qn-panel" role="listbox">
          ...
          <a class="qn-item" href="#about-site"><span class="qn-dot amber"></span><span class="qn-nm">What Is This Website</span><span class="qn-side">Intro</span></a>
          <div class="qn-sec">Ships</div>
          <a class="qn-item" href="#dossiers"><span class="qn-dot amber"></span><span class="qn-nm">Ships</span><span class="qn-side">Section</span></a>
          <a class="qn-item" href="#activities"><span class="qn-dot amber"></span><span class="qn-nm">Activity Field Manuals</span><span class="qn-side">Ships</span></a>
          <a class="qn-item" href="#best-ships"><span class="qn-dot amber"></span><span class="qn-nm">Best Ships by Role</span><span class="qn-side">Ships</span></a>
          <a class="qn-item" href="#ship-dossiers"><span class="qn-dot amber"></span><span class="qn-nm">Ship Dossiers</span><span class="qn-side">Ships</span></a>
          <div class="qn-sec">Engineering</div>
          <a class="qn-item" href="#engineering"><span class="qn-dot amber"></span><span class="qn-nm">Engineering</span><span class="qn-side">Section</span></a>
          <a class="qn-item" href="#eng-manuals"><span class="qn-dot amber"></span><span class="qn-nm">Engineering Manuals</span><span class="qn-side">Engineering</span></a>
          <a class="qn-item" href="#farming"><span class="qn-dot amber"></span><span class="qn-nm">Material Farming</span><span class="qn-side">Engineering</span></a>
          <div class="qn-sec">Systems</div>
          <a class="qn-item" href="#systems"><span class="qn-dot amber"></span><span class="qn-nm">Systems</span><span class="qn-side">Section</span></a>
          <a class="qn-item" href="#new-pilot"><span class="qn-dot amber"></span><span class="qn-nm">New Pilot &amp; Interface</span><span class="qn-side">Systems</span></a>
          <a class="qn-item" href="#galaxy"><span class="qn-dot amber"></span><span class="qn-nm">Galaxy &amp; Power Systems</span><span class="qn-side">Systems</span></a>
          <a class="qn-item" href="#combat-venues"><span class="qn-dot amber"></span><span class="qn-nm">Combat Venues</span><span class="qn-side">Systems</span></a>
          <div class="qn-sec">More</div>
          <a class="qn-item" href="#faq"><span class="qn-dot amber"></span><span class="qn-nm">FAQ</span><span class="qn-side">Info</span></a>
          <a class="qn-item" href="#changelog"><span class="qn-dot amber"></span><span class="qn-nm">Changelog</span><span class="qn-side">Info</span></a>
...
<div class="wrap">
  ...
  <header class="masthead">
    <div class="kicker">Elite Dangerous<span class="sep">//</span>Field Manuals</div>
    <h1 class="title">Elite:Dangerous <span>Black Box</span></h1>
    <div class="masthead-meta">
      <span><b>100+</b> field manuals</span>
  ...
  <div class="verdict">
    ...
    <p>The Black Box collects operator-grade field manuals for Elite Dangerous into a single index: the engineering referral tree and blueprint catalogue, material-farm routes, activity playbooks, "best ship for the job" ladders, and a full set of ship &times; role dossiers. New here? Read <a href="#about-site">What Is This Website</a>, then dive into Ships, Engineering or Systems.</p>
    <div class="stat-grid">
  ...
  <section id="about-site">
    ...
    <p>The <strong>Elite:Dangerous Black Box</strong> is a library of operator-grade field manuals for <em>Elite Dangerous: Odyssey</em>, written commander-to-commander. It pulls the things you actually look up mid-session — engineer unlocks, blueprint material costs, farm routes, where to fight, what to fly — into one cross-linked reference, with every page citing its sources.</p>
  ...
  <section id="dossiers">
    ...
    <h3 class="subhead" id="activities">Activity Field Manuals</h3>
...
cat <<'SHIPS2'
    ...
    <h3 class="subhead" id="best-ships">Best Ships by Role</h3>
...
cat <<'SHIPS3'
    ...
    <h3 class="subhead" id="ship-dossiers">Ship Dossiers</h3>
...
cat <<'SYS'
  ...
  <section id="systems">
    ...
    <h3 class="subhead" id="new-pilot">New Pilot &amp; Interface</h3>
...
cat <<'SYS2'
    ...
    <h3 class="subhead" id="galaxy">Galaxy &amp; Power Systems</h3>
...
cat <<'SYS3'
    ...
    <h3 class="subhead" id="combat-venues">Combat Venues</h3>
