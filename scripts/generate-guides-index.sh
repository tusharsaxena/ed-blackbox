...
cat <<'FOOT'
  ...
  <section id="section-faq">
    ...
    <div class="faq">
      ...
      <div class="faq-row"><h4 class="faq-q">Is this a complete guide to the game?</h4><p class="faq-a">No. The Black Box covers only the ships, systems and activities I've worked through myself so far &mdash; not the whole of Elite Dangerous. I add guides as I get hands-on with more of the game, so the library keeps growing; expect gaps, and expect them to fill in over time. Want something specific covered next? <a href="https://github.com/tusharsaxena/ed-blackbook/issues">Open a feature request</a>.</p></div>
      <div class="faq-row"><h4 class="faq-q">Does this apply to my platform (PC / console)?</h4><p class="faq-a">Yes. Ship stats, modules and engineering are the same on PC and console, so the ratings and builds hold wherever you play.</p></div>
